...
Spotify's web interface is a dark, immersive music player that wraps listeners in a near-black cocoon (`#121212`, `#181818`, `#1f1f1f`) where album art and content become the primary source of color. The design philosophy is "content-first darkness" — the UI recedes into shadow so that music, podcasts, and playlists can glow. Every surface is a shade of charcoal, creating a theater-like environment where the only true color comes from the iconic Soritune Orange (`#FF5E00`) and the album artwork itself.

The typography uses Pretendard — a free geometric sans-serif (SIL Open Font License) with native Korean support and an Inter-like aesthetic that closely matches Circular's feel. The type system is compact and functional: 700 (bold) for emphasis and navigation, 600 (semibold) for secondary emphasis, and 400 (regular) for body. Buttons use uppercase with positive letter-spacing (1.4px–2px) for a systematic, label-like quality.
...
- Soritune Orange (`#FF5E00`) as singular brand accent — never decorative, always functional
- Pretendard font family with native Korean support
...
### Primary Brand
- **Soritune Orange** (`#FF5E00`): Primary brand accent — play buttons, active states, CTAs
...
- **Soritune Orange Border** (`#E65500`): Orange accent border variant
...
### Font Families
- **Title / UI / Body**: `Pretendard`, fallbacks: `"Pretendard Variable", -apple-system, BlinkMacSystemFont, system-ui, Roboto, "Helvetica Neue", "Segoe UI", "Apple SD Gothic Neo", "Noto Sans KR", "Malgun Gothic", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif`
...
|------|------|------|--------|-------------|----------------|-------|
| Section Title | Pretendard | 24px (1.50rem) | 700 | normal | normal | Bold title weight |
| Feature Heading | Pretendard | 18px (1.13rem) | 600 | 1.30 (tight) | normal | Semibold section heads |
| Body Bold | Pretendard | 16px (1.00rem) | 700 | normal | normal | Emphasized text |
| Body | Pretendard | 16px (1.00rem) | 400 | normal | normal | Standard body |
| Button Uppercase | Pretendard | 14px (0.88rem) | 600–700 | 1.00 (tight) | 1.4px–2px | `text-transform: uppercase` |
| Button | Pretendard | 14px (0.88rem) | 700 | normal | 0.14px | Standard button |
| Nav Link Bold | Pretendard | 14px (0.88rem) | 700 | normal | normal | Navigation |
| Nav Link | Pretendard | 14px (0.88rem) | 400 | normal | normal | Inactive nav |
| Caption Bold | Pretendard | 14px (0.88rem) | 700 | 1.50–1.54 | normal | Bold metadata |
| Caption | Pretendard | 14px (0.88rem) | 400 | normal | normal | Metadata |
| Small Bold | Pretendard | 12px (0.75rem) | 700 | 1.50 | normal | Tags, counts |
| Small | Pretendard | 12px (0.75rem) | 400 | normal | normal | Fine print |
| Badge | Pretendard | 10.5px (0.66rem) | 600 | 1.33 | normal | `text-transform: capitalize` |
| Micro | Pretendard | 10px (0.63rem) | 400 | normal | normal | Smallest text |
...
- **Korean-first typography**: Pretendard provides native Korean glyphs with geometric sans-serif aesthetics, with system fallbacks (Apple SD Gothic Neo, Noto Sans KR, Malgun Gothic) for maximum compatibility.
...
### Navigation
- Dark sidebar with Pretendard 14px weight 700 for active, 400 for inactive
- `#b3b3b3` muted color for inactive items, `#ffffff` for active
- Circular icon buttons (50% radius)
- Logo top-left in Soritune Orange
...
- Apply Soritune Orange (`#FF5E00`) only for play controls, active states, and primary CTAs
...
### Don't
- Don't use Soritune Orange decoratively or on backgrounds — it's functional only
...
- Accent: Soritune Orange (`#FF5E00`)
- Border: `#4d4d4d`
- Error: Negative Red (`#f3727f`)

### Example Component Prompts
- "Create a dark card: #181818 background, 8px radius. Title at 16px Pretendard weight 700, white text. Subtitle at 14px weight 400, #b3b3b3. Shadow rgba(0,0,0,0.3) 0px 8px 8px on hover."
- "Design a pill button: #1f1f1f background, white text, 9999px radius, 8px 16px padding. 14px Pretendard weight 700, uppercase, letter-spacing 1.4px."
- "Build a circular play button: Soritune Orange (#FF5E00) background, #000000 icon, 50% radius, 12px padding."
- "Create search input: #1f1f1f background, white text, 500px radius, 12px 48px padding. Inset border: rgb(124,124,124) 0px 0px 0px 1px inset."
- "Design navigation sidebar: #121212 background. Active items: 14px weight 700, white. Inactive: 14px weight 400, #b3b3b3."

### Iteration Guide
1. Start with #121212 — everything lives in near-black darkness
2. Soritune Orange for functional highlights only (play, active, CTA)
