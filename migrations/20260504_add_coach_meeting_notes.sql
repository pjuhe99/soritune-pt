...
-- NOTE: idx_coach_date에 DESC 키워드 없음. MariaDB 10.5는 DESC 인덱스를 ASC로 저장.
--       ORDER BY meeting_date DESC, id DESC는 InnoDB 역방향 스캔으로 동일 성능.
CREATE TABLE IF NOT EXISTS `coach_meeting_notes` (
